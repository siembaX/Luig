...
<section class="story-area left-text center-sm-text pos-relative">
        ...
        <div class="container">
                <div class="heading">
                        <img src="<?php echo get_template_directory_uri().'/assets/images/heading_logo.png'; ?>" alt="" class="img-fluid heading-img" />
                        <h2>Our Story</h2>
                </div>
...
<section class="story-area bg-seller color-white pos-relative">
        ...
        <div class="container">
                ...
                <div class="row">
                        <div class="col-lg-3 col-md-4  col-sm-6 ">
                                <div class="center-text mb-30">
                                        <div class="ïmg-200x mlr-auto pos-relative">
                                                ...
                                                <img src="<?php echo get_template_directory_uri().'/assets/images/seller-2-200x200.png'; ?>" alt="" class="img-fluid br-3" />
                                        </div>
                        ...
                        <div class="col-lg-3 col-md-4  col-sm-6 ">
                                <div class="center-text mb-30">
                                        <div class="ïmg-200x mlr-auto pos-relative"> <img src="<?php echo get_template_directory_uri().'/assets/images/seller-2-200x200.png'; ?>" alt="" class="img-fluid" /></div>
                                        <h5 class="mt-20">Pizza Margherita</h5>
                                        <h4 class="mt-5"><b>$11.90</b></h4>
                                        <h6 class="mt-20"><a href="#" class="btn-brdr-primary plr-25"><b>Order Now</b></a></h6>
                                </div><!--text-center-->
                        ...
                        <div class="col-lg-3 col-md-4  col-sm-6 ">
                                <div class="center-text mb-30">
                                        <div class="ïmg-200x mlr-auto pos-relative">
                                                ...
                                                <img src="<?php echo get_template_directory_uri().'/assets/images/seller-2-200x200.png'; ?>" alt="" class="img-fluid" />
                                        </div>
                                        <h5 class="mt-20">Pizza Margherita</h5>
                                        <h4 class="mt-5"><b>$11.90</b></h4>
                                        <h6 class="mt-20"><a href="#" class="btn-brdr-primary plr-25"><b>Order Now</b></a></h6>
                ...
                <div class="row">
                        <div class="col-md-6 food-menu pizza">
                                <div class="sided-90x mb-30 ">
                                        <div class="s-left"><img src="<?php echo get_template_directory_uri().'/assets/images/menu-1-120x120.jpg'; ?>" alt="Menu Image" class="img-fluid br-3" /></div><!--s-left-->
                                        <div class="s-right">
                        ...
                        <div class="col-md-6 food-menu pizza pasta">
                                <div class="sided-90x mb-30 ">
                                        <div class="s-left"><img src="<?php echo get_template_directory_uri().'/assets/images/menu-2-120x120.jpg'; ?>" alt="Menu Image" class="img-fluid br-3" /></div><!--s-left-->
                                        <div class="s-right">
                        ...
                        <div class="col-md-6 food-menu pasta">
                                <div class="sided-90x mb-30 ">
                                        <div class="s-left"><img src="<?php echo get_template_directory_uri().'/assets/images/menu-3-120x120.jpg'; ?>" alt="" class="img-fluid br-3" /></div><!--s-left-->
                        ...
                        <div class="col-md-6 food-menu salads">
                                <div class="sided-90x mb-30">
                                        <div class="s-left"><img src="<?php echo get_template_directory_uri().'/assets/images/menu-4-120x120.jpg'; ?>" alt="" class="img-fluid br-3" /></div><!--s-left-->
                                        <div class="s-right">
                        ...
                        <div class="col-md-6 food-menu deserts">
                                <div class="sided-90x mb-30">
                                        <div class="s-left"><img src="<?php echo get_template_directory_uri().'/assets/images/menu-5-120x120.jpg'; ?>" alt="" class="img-fluid br-3" /></div><!--s-left-->
                                        <div class="s-right">
                                                <h5 class="mb-10"><b>Pizza Margherita</b><b class="color-primary float-right">$12.00</b></h5>
                                                <p class="pr-70">Maecenas fermentum tortor id fringilla molestie. In hac habitasse platea dictumst. </p>
                                        </div><!--s-right-->
                        ...
                        <div class="col-md-6 food-menu pizza">
                                <div class="sided-90x mb-30 ">
                                        <div class="s-left"><img src="<?php echo get_template_directory_uri().'/assets/images/menu-6-120x120.jpg'; ?>" alt="" class="img-fluid br-3" /></div><!--s-left-->
                                        <div class="s-right">
                                                <h5 class="mb-10"><b>Italian pasta</b><b class="color-primary float-right">$20.00</b></h5>
                                                <p class="pr-70">Proin dictum viverra varius. Etiam vulputate libero dui, at pretium elit elementum quis. </p>
                                        </div><!--s-right-->
                        ...
                        <div class="col-md-6 food-menu deserts">
                                <div class="sided-90x mb-30">
                                        <div class="s-left"><img src="<?php echo get_template_directory_uri().'/assets/images/menu-7-120x120.jpg'; ?>" alt="" class="img-fluid br-3" /></div><!--s-left-->
                                        <div class="s-right">
                                                <h5 class="mb-10"><b>Pizza Prosciuto</b><b class="color-primary float-right">$12.00</b></h5>
                                                <p class="pr-70">Maecenas fermentum tortor id fringilla  molestie. In hac habitasse platea dictumst. </p>
                                        </div><!--s-right-->
                        ...
                        <div class="col-md-6 food-menu pasta">
                                <div class="sided-90x mb-30 ">
                                        <div class="s-left"><img src="<?php echo get_template_directory_uri().'/assets/images/menu-8-120x120.jpg'; ?>" alt="" class="img-fluid br-3" /></div><!--s-left-->
